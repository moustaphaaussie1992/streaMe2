...
?>
            <button style="  background-color: #04AA6D; /* Green */
                    ...
                    "class="button button1"><?php 
//                \yii\helpers\VarDumper::dump($following,3,3);
//                die();
                    if($following) echo 'Unfollow';
                    else echo 'Follow'?>
            </button>
                <?php } ?>
            <br><!-- comment -->
            ...
            <div class=" col-lg-6 col-lg-offset-3" style="background: white; padding: 2px;border-radius: 10px; margin-bottom: 10px;">
                ...
                <div class="splide__track">
                    ...
                    <video   style="background: black ;width: 100%; height: 500px;border-radius: 10px; object-fit: contain;" controls>
                        <source src="<?= "http://" . Yii::$app->params['domain'] . "/postVideos/" . $rooms[$i]["files"] ?>" type="video/mp4">
                    ...
                    if ($rooms[$i]["category"] == "donate") {
                        ...
                        <path id="Path_104" data-name="Path 104" d="M1091.777,267.414a9.614,9.614,0,0,0-2.1-3.366.426.426,0,0,0-.575-.112,5.059,5.059,0,0,1-3.959.075.4.4,0,0,0-.356.056,8.941,8.941,0,0,0-2.131,3.422,2.573,2.573,0,0,0,1.641,3.4,7.547,7.547,0,0,0,2.879.471,8.5,8.5,0,0,0,2.888-.437A2.593,2.593,0,0,0,1091.777,267.414Zm-3.134,1.906a1.2,1.2,0,0,1-.517.432,1.738,1.738,0,0,1-.643.15v.253a.229.229,0,1,1-.459,0v-.266a1.9,1.9,0,0,1-.555-.138,1.24,1.24,0,0,1-.568-.469,1.3,1.3,0,0,1-.183-.432.243.243,0,0,1,.213-.3l.031,0a.243.243,0,0,1,.254.186.949.949,0,0,0,.124.281.885.885,0,0,0,.4.307,1.305,1.305,0,0,0,.288.088v-1.421a3.173,3.173,0,0,1-.63-.214,1.082,1.082,0,0,1-.421-.368.908.908,0,0,1-.138-.491,1.014,1.014,0,0,1,.169-.559,1.045,1.045,0,0,1,.5-.393,1.836,1.836,0,0,1,.525-.127v-.272a.229.229,0,1,1,.459,0v.278a1.832,1.832,0,0,1,.513.127,1.12,1.12,0,0,1,.516.416,1.166,1.166,0,0,1,.151.34.239.239,0,0,1-.215.3l-.031,0a.246.246,0,0,1-.251-.182.738.738,0,0,0-.234-.368.864.864,0,0,0-.449-.174v1.255a4.1,4.1,0,0,1,.667.2,1.2,1.2,0,0,1,.509.4.973.973,0,0,1,.165.561A1.084,1.084,0,0,1,1088.643,269.32Z" transform="translate(-1080.681 -257.03)" fill="url(#linear-gradient)"/>
                        <path id="Path_105" data-name="Path 105" d="M1130.837,304.688a3.529,3.529,0,0,0-.375-.11v1.332a1.333,1.333,0,0,0,.386-.082.74.74,0,0,0,.339-.244.56.56,0,0,0,.112-.338.514.514,0,0,0-.107-.324A.808.808,0,0,0,1130.837,304.688Z" transform="translate(-1123.66 -293.507)" fill="url(#linear-gradient)"/>
                        <path id="Path_106" data-name="Path 106" d="M1119.43,287.8a.45.45,0,0,0,.154.351,1.476,1.476,0,0,0,.533.218v-1.151a.889.889,0,0,0-.47.164A.521.521,0,0,0,1119.43,287.8Z" transform="translate(-1113.774 -277.951)" fill="url(#linear-gradient)"/>
                        <path id="Path_107" data-name="Path 107" d="M1092.784,223.037a1.562,1.562,0,0,1,.9.177,3.29,3.29,0,0,0,2.249.775,3.782,3.782,0,0,0,2.133-.54,1.24,1.24,0,0,0,.494-.609,4.431,4.431,0,0,0,.169-1.369,2.679,2.679,0,0,0-.489-1.49.379.379,0,0,0-.465-.121,4.522,4.522,0,0,1-3.383-.028.861.861,0,0,0-.917.182,2.307,2.307,0,0,1-.737.388c-.2.061-.259.133-.256.332.01.672.014,1.345,0,2.017C1092.477,222.993,1092.559,223.028,1092.784,223.037Z" transform="translate(-1089.626 -217.506)" fill="url(#linear-gradient)"/>
                        <path id="Path_108" data-name="Path 108" d="M1066.975,223.067a.593.593,0,0,0-.593-.593h-.805a.593.593,0,0,0-.593.593v2.37a.593.593,0,0,0,.593.593h.805a.593.593,0,0,0,.593-.593Zm-.973.807a.383.383,0,0,1-.435-.4.4.4,0,0,1,.4-.433.4.4,0,0,1,.428.425A.381.381,0,0,1,1066,223.875Z" transform="translate(-1064.983 -219.932)" fill="url(#linear-gradient)"/>
                        <path id="Path_109" data-name="Path 109" d="M1113.459,199.366a1.126,1.126,0,0,0,.742.5,2.23,2.23,0,0,0,.781,0,1.126,1.126,0,0,0,.742-.5l.394-.609a.153.153,0,0,0-.148-.234l-.4.053a.612.612,0,0,1-.554-.219l-.209-.256a.277.277,0,0,0-.429,0l-.209.256a.612.612,0,0,1-.554.219l-.4-.053a.152.152,0,0,0-.148.234Z" transform="translate(-1108.048 -198)" fill="url(#linear-gradient)"/>
                        </g>
                        </svg>
